...
public class QuestionController {
    ...
    @PostMapping("getQuestionsByAuthor")
    public ResponseEntity<?> getQuestionsByAuthorFromIds(@RequestBody List<Integer> questionIds) {

        return questionService.getQuestionsByAuthorFromIds(questionIds);
    }
